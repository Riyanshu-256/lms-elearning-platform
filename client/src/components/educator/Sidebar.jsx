      ...
      <div className="md:w-64 w-16 border-r min-h-screen text-base border-gray-500 py-2 flex flex-col">
        {menuItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `group relative flex items-center md:flex-row flex-col 
          ...
          >
            ...
            {/* Mobile Tooltip */}
            <span
              className="absolute left-16 bg-black text-white text-xs 
              px-2 py-1 rounded opacity-0 scale-95 
              group-hover:opacity-100 group-hover:scale-100 
              transition-all duration-200 md:hidden whitespace-nowrap"
            >
              {item.name}
            </span>
          </NavLink>
